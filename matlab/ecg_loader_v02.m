...
ax(17)=subplot(2,1,2); hold on ; plot(vec_t,good_sections.*1.15); hold on % ylim([0 1.2]);  ylabel('ECG peak detections')
ax(18)=subplot(2,1,2); plot(vec_t,good_sig_flag.*1.05,'c');
xlabel('time (hours)');
