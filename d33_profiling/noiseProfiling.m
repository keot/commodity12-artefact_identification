% noiseProfiling: runs the SQI metrics on various simulated signals with noise

function [answers] = noiseProfiling()
	%Configure experiment
	bpm_range = [60:60:180]; % incl.
	noise_range = [100.0, 50.0, 25.0, 12.5, 0.0]; %6.25, 3.125, 1.5625, 0.78125, 0.390625, 0.1953125, 0.0]; % SNR dB: 0,-3,-6,-9,..,-27,Inf
	...
	parfor i = [1:length(answers)]
		...
		answer = sqi( ...
					...
					addEmgNoise( ...
					attenuate( ...
						ecgsyn(fs, bpm*2, 0, bpm, 1, 0.5, fs) ... %two minute segments
